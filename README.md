...
4. **Verify** (`gti-verify`) — requires the **Playwright MCP** to be configured (see [Installation](#installation)). Three gates must all pass before the workflow can move forward:
...
docs/<feature-name>/
  ...
  conclusion.md            # Generated by gti-conclusion after verification passes
```
